...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    img_product: Schema.Attribute.Media<'images' | 'files', true> &
    ...
    productStatus: Schema.Attribute.Enumeration<
      ['available', 'sold', 'reserved', 'inProgress']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    orderStatus: Schema.Attribute.Enumeration<['pending', 'sent', 'delivered']>;
    publishedAt: Schema.Attribute.DateTime;
    purchaseDate: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer;
    shopper: Schema.Attribute.Relation<'manyToOne', 'api::shopper.shopper'>;
